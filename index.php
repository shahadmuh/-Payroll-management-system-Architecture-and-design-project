      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#service">Maintain Timecard</a></li>
            <li><a href="#portfolio">Select Payment Method</a></li>
            <li><a href="#about">Create Employee Report </a></li>
			...
			<div class="search-box">
				...
				<form action="" class="loginForm">
					<div class="input-group">
						...
						<input class="button-medium" id="contact-submit" type="submit" value="Submit">
					</div>
				</form>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-4 text-center">
			<div class="search-box">
				<div class="caption">
					<h3>Enter Timecard Information</h3>
					
				</div>
				<form action="" class="HoursForm">
					<div class="input-group">
						<input type="text" id="name" name="hours" class="form-control" placeholder="Hours">
						
						<input class="button-medium" id="contact-submit" name="save" type="submit" value="Save">
						<input class="button-medium" id="contact-submit" name="submitM" type="submit" value="Submit">
					</div>
				</form>
			</div>
		</div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <ul id="portfolio-flters">
            <li>pick up <input class="button-medium" name="pickSub" id="contact-submit" type="submit" value="select"></li>
            <li>mail<input class="button-medium" name="mailSub" id="contact-submit" type="submit" value="select"></li>
            <li>direct deposite <input class="button-medium" name="directSub" id="contact-submit" type="submit" value="select"></li>
      ...
      <div class="row" id="portfolio-wrapper">
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            ...
            <div class="details">
              <h4>Mail address</h4>
              <form action="" class="loginForm">
						<input type="text" id="name" name="mailAdr" class="MailForm"  placeholder="Mail Address">
						<input class="button-medium" id="contact-submit"  name="mailAdrsSub" type="submit" value="Submit">
						</form>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            ...
            <div class="details">
              <h4>Bank Account</h4>
              <form action="" class="loginForm">
						<input type="text" id="name" class="form-control" name="Acc" placeholder="Bank Account">
						<input class="button-medium" id="contact-submit" name="AccSub" type="submit" value="Submit">
						</form>
            </div>
        ...
        <div class="page-title text-center">
          ...
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                              <div class="dropdown">
  <a href="report.html" ><button class="button-medium" id="contact-submit" type="submit" value="report">choose the information for report</button> </a>
